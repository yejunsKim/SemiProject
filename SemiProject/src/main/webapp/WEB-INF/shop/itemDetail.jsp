...
<script type="text/javascript">
	...
	<div class="col-md-12" style="background-color: #f5f5f5;padding-top:80px;">
		...
		<div class="d-flex">
			<div class="col-8 my-5" style="border-right: 1px solid #ccc; text-align: center;">
				<img class="mt-4" src="<%= ctxPath%>${item.itemPhotoPath}" class="img-fluid" style="max-width: 500px;">
			</div>
