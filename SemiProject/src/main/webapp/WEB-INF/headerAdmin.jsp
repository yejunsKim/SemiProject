...
.adminTab-wrapper {position: fixed;top: 63px;right: -250px;z-index: 0;width: 250px;height: 880px;overflow: hidden;}

.adminTab-wrapper.wrapperOpen {z-index: 21;right:0px;}
.adminTab {width: 250px;height: 100%;position: absolute;right: -250px;top: 0;background: rgba(255, 255, 255, 0.6);transition: right 0.9s ease;border-left: 1px solid #ddd;border-top: 1px solid #ddd;z-index: 11;}
.adminTab.adminTab-open {right: 0;}

@media screen and (max-width:650px) {
	.adminTab{width:150px;}
	.adminTab-wrapper {width:150px;}
}
...
<li class="logins" id="adminUser" style="font-size:19pt;cursor:pointer;"><i class="fas fa-user-circle mr-2"></i></li>
